...
/* ============================================================
   ...
   - Reuses the site's existing artwork (no copyrighted scraping).
   - 40+ memory slots: drop your own legally-sourced JK photos as
     /memories/m01.jpg … /memories/m44.jpg and they float in here.
   ============================================================ */

const REAL_IMAGES = [
  "/images/jk-art.jpg",
  "/images/jk-stage.jpg",
  "/images/khadiza-art.jpg",
  "/images/borahae.jpg",
  "/images/hero-bg.jpg",
];
...
function buildMemories(compact: boolean) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const mem: Memory = {
      id: i,
      src: real
        ? REAL_IMAGES[Math.floor(rnd() * REAL_IMAGES.length)]
        : `/memories/m${String(i + 1).padStart(2, "0")}.jpg`,
      x: 2 + rnd() * 94,
...
export default function MemoryBackground() {
  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      {/* ============ readability overlay — keeps content crisp ============ */}
      <div className="absolute inset-0 bg-gradient-to-b from-night-950/70 via-night-950/45 to-night-950/80" />
      <div
        className="absolute inset-0"
        style={{ background: "radial-gradient(ellipse at 50% 40%, transparent 30%, rgba(10,2,20,0.55) 100%)" }}
      />
    </div>
  );
}
