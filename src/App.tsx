...
import MemoryBackground, { ForegroundDust } from "./components/MemoryBackground";
...
export default function App() {
  ...
  // subtle cursor-based 3D tilt for cards (desktop only, respects reduced motion)
  useEffect(() => initCardTilt(), []);
  ...
  return (
    <div className="relative min-h-screen bg-night-950 font-sans text-white antialiased">
      ...
      <footer className="relative z-10 border-t border-bora-400/15 py-10">
      ...
      {/* Layer 5 — foreground dust above the content */}
      <ForegroundDust />
    </div>
  );
}
